    ...
    try {
      switch (currentNode.label) {
        ...
        case 'event-click': {
          ...
          try {
            // 转换XPath选择器
            if (findBy === 'xpath' || selector.startsWith('id(') || selector.startsWith('//')) {
              // 转换 id("xxx") 为 #xxx
        ...
        case 'get-text': {
          ...
          try {
            ...
            console.log(`   📝 提取文本 [${dataColumn}]: ${text?.substring(0, 50)}...`);
        ...
        case 'attribute-value': {
          ...
          try {
            ...
            console.log(`   🏷️  提取属性 [${dataColumn}]: ${attr?.substring(0, 50)}...`);
