...
/>
          ...
          <div class="workflow-sort mt-4 flex items-center lg:mt-0">
            ...
            <ui-select
v-model="sortState.by" :placeholder="t('sort.sortBy')"
>
              <option
...
>
              ...
              <ui-popover>
                ...
                <ui-list
class="space-y-1" style="min-width: 180px"
>
                  <ui-list-item
                    v-if="pkg.isExternal"
                    v-close-popover
                  ...
                  >
                    <v-remixicon
name="riExternalLinkLine" class="mr-2 -ml-1"
/>
...
/>
                    ...
                    >
                      <v-remixicon
name="riDownloadLine" class="mr-2 -ml-1"
/>
...
/>
            ...
            >
              ...
              <p
v-if="pkg.author" class="text-overflow ml-4 flex-1 text-right"
>
                By {{ pkg.author }}
              </p>
            </div>
    ...
    >
      ...
      <div class="mt-6 flex space-x-4">
        <ui-button
class="flex-1" @click="clearNewPackage"
>
          {{ t('common.cancel') }}
        </ui-button>
        <ui-button
class="flex-1" variant="accent"
@click="addPackage"
>
          {{ t('packages.add') }}
        </ui-button>
