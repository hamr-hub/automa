<template>
  <div v-if="currentLog.id">
    <div class="flex items-center">
      ...
      <ui-button
class="text-red-500 dark:text-red-400" @click="deleteLog"
>
        {{ t('common.delete') }}
      </ui-button>
    </div>
    <ui-tabs
v-model="state.activeTab" class="mt-4"
@change="onTabChange"
>
      <ui-tab
v-for="tab in tabs" :key="tab.id"
class="mr-4" :value="tab.id"
>
        {{ tab.name }}
      </ui-tab>
    </ui-tabs>
    ...
    >
      ...
      <ui-tab-panel value="table">
        <logs-table
:current-log="currentLog" :table-data="tableData"
/>
      </ui-tab-panel>
