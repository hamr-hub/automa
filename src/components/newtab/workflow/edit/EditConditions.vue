<template>
  <div>
    ...
    <div class="my-4 flex items-center space-x-2">
      <p
v-if="state.showSettings" class="font-semibold"
>
        {{ t('common.settings') }}
      </p>
      <ui-button
    ...
    <template v-if="state.showSettings">
      ...
      <div
v-if="data.retryConditions" class="mt-2"
>
        <ui-input
    ...
    >
      <template #item="{ element, index }">
        <ui-list-item class="group cursor-move">
          <v-remixicon
name="riGuideLine" size="20"
class="mr-2 -ml-1"
/>
          <p
class="text-overflow flex-1" :title="element.name"
>
            {{ element.name }}
          </p>
          <v-remixicon
    ...
    <ui-modal
v-model="state.showModal" custom-content
>
      <ui-card
