...
>
        ...
        <ui-select
v-model="state.toDo" class="mt-2 w-56"
>
          <option
        ...
        <transition-expand>
          <table
v-if="state.insertData" class="mt-2 w-full"
>
            <thead>
            ...
            <tbody>
              <tr
v-for="(item, index) in state.dataToInsert" :key="index"
>
                <td>
                ...
                <td>
                  <ui-input
v-model="item.value" placeholder="EMPTY"
/>
                </td>
                <td>
                  <v-remixicon
