<template>
  ...
  >
    ...
    >
      <option
v-for="item in insertOptions" :key="item"
:value="item"
>
    ...
    >
      <template #header>
        <ui-tabs
v-model="state.activeTab" class="space-x-1 border-none"
>
          <ui-tab
...
>
        ...
        <ui-tab-panel value="preloadScript">
          <ul class="my-1 space-y-2">
            ...
            >
              <ui-select
v-model="item.type" placeholder="Type"
>
          ...
          <ui-button
class="mt-4" @click="addPreloadScript"
>
            Add script
          </ui-button>
        </ui-tab-panel>
