<template>
  <div class="cloud-backup mt-4 flex items-start">
    ...
    <div
v-if="!state.backupRetrieved" class="content block flex-1 text-center"
>
      <ui-spinner color="text-accent" />
    </div>
    <div
v-else class="ml-4 flex-1 overflow-hidden"
>
      <template v-if="state.activeTab === 'cloud'">
        ...
        >
          ...
          />
          <div
v-else class="invisible ml-4 group-hover:visible"
>
            <button
