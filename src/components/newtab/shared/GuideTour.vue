<template>
  <div v-if="isActive" class="guide-tour-overlay fixed inset-0 z-50 flex items-center justify-center">
    <!-- 遮罩层 -->
    ...
    >
      ...
      <!-- 引导内容 -->
      <div class="p-6">
        <h3 class="text-xl font-semibold mb-3 dark:text-white">{{ step.title }}</h3>
        ...
        <div class="flex justify-between items-center">
          <div class="flex items-center space-x-2">
            ...
            >
            <label for="guide-tour-skip" class="text-sm text-gray-500 dark:text-gray-400">{{ t('guide.skipTour') }}</label>
          </div>
