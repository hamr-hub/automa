    ...
    <template #header>
      <div class="mb-4 flex items-center">
        ...
        <template v-if="workflow && !workflow.isDisabled">
          ...
          />
          <span
v-else class="bg-box-transparent inline-block rounded-lg p-2"
>
...
v-else class="py-2">
        ...
        <ui-popover class="ml-2 h-6">
          ...
          <ui-list
class="space-y-1" style="min-width: 165px"
>
            <ui-list-item
...
/>
            ...
            <ui-list-item
class="cursor-pointer" @click="$emit('togglePin')"
>
              <v-remixicon
name="riPushpin2Line" class="mr-2 -ml-1"
/>
              <span>{{
